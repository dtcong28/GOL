...
<div class="container pt-4">
    @if(empty($permission))
    <div class="row">
        <h3 class="col-4">@lang('Create Permission')</h3>
        <div class="col-6"></div>
    ...
    <form method="post" action="{{route('permission.store')}}">
        @else
        <div class="row">
            <h3 class="col-4">@lang('Edit Permission')</h3>
            <div class="col-6"></div>
            <button class="btn btn-primary" style="width: 100px"><a href="/admin/permission" style="color: white">@lang('Back')</a>
            </button>
        ...
        <form method="post" action="{{route('permission.update',$permission->id)}}">
            ...
            <div class="form-group pt-3">
                <label>@lang('Select permission group')</label>
                <select class="form-select" name="permission_group_id">
                    @if(empty($permission))
                    <option selected>--@lang('Select permission group')--</option>
                    @endif
